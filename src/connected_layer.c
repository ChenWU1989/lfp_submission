...
layer make_connected_layer(int batch, int inputs, int outputs, ACTIVATION activation, int batch_normalize, int adam)
{
    ...
    if(batch_normalize){
        l.bn_scales = calloc(outputs, sizeof(float));
        l.bn_biases = calloc(outputs, sizeof(float));
    ...
    if(batch_normalize){
        l.bn_scales_gpu = cuda_make_array(l.bn_scales, outputs);
        l.bn_biases_gpu = cuda_make_array(l.bn_biases, outputs);
