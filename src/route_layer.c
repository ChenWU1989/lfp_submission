...
route_layer make_route_layer(int batch, int n, int *input_layers, int *input_sizes)
{
    ...
    l.norm_in_mean = calloc(outputs*batch, sizeof(float));
    l.norm_in_var  = calloc(outputs*batch, sizeof(float));
    l.norm_out_mean = calloc(outputs*batch, sizeof(float));
    l.norm_out_var  = calloc(outputs*batch, sizeof(float));
