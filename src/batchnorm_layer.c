...
layer make_batchnorm_layer(int batch, int w, int h, int c)
{
    ...
    l.bn_scales = calloc(c, sizeof(float));
    l.bn_biases = calloc(c, sizeof(float));
    ...
    l.bn_scales_gpu = cuda_make_array(l.bn_scales, c);
    l.bn_biases_gpu = cuda_make_array(l.bn_biases, c);
...
void forward_batchnorm_layer(layer l, network net)
{
  ...
  if(net.train){
    ...
    lfp_normalize_cpu(l.output, l.bn_scales, l.bn_biases, l.batch, l.out_c, l.out_h*l.out_w); 
    if ( (l.lfp->type != FP32) && (l.type == BATCHNORM) ) { 
      printf("Batch normalization layer.\n");
#ifdef LFP_DEBUG
...
void forward_batchnorm_layer_gpu(layer l, network net)
{
    ...
    if (net.train) {
      ...
      lfp_normalize_gpu(l.output_gpu, l.bn_scales_gpu, l.bn_biases_gpu, l.batch, l.out_c, l.out_h*l.out_w);
      if ( (l.lfp->type != FP32) && (l.type == BATCHNORM) ) {
#ifdef LFP_DEBUG
